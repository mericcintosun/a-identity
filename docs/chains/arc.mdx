...
Arc is the **primary rail**: gas in USDC, a unified balance via Circle Gateway, and
sub-cent x402 pay-per-call settlement verified on-chain. Base and the other chains are
fallbacks. Identity stays on ERC-8004, which Arc speaks natively because it is EVM
compatible.
